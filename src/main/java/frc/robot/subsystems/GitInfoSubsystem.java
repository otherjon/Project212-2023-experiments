...
public class GitInfoSubsystem extends SubsystemBase {
  ...
  private int extraLocalCommits;
  private int extraRemoteCommits;
 ...
 public GitInfoSubsystem() {
   ...
   try {
     String elcString = getFirstLineOfGitInfoFile("extra-local-commits.txt");
     extraLocalCommits = Integer.valueOf(elcString);
   } catch (ValueError e) {
     extraLocalCommits = -1;
   }
   try {
     String ercString = getFirstLineOfGitInfoFile("extra-remote-commits.txt");
     extraRemoteCommits = Integer.valueOf(ercString);
   } catch (ValueError e) {
     extraRemoteCommits = -1;
   }
 }
  ...
  public int extraLocalCommits() {
    return extraLocalCommits;
  }

  public int extraRemoteCommits() {
    return extraLocalCommits;
  }
