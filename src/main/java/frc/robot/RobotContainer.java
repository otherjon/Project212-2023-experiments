...
public class RobotContainer {
  ...
  // Command instances
  private final Command autoCmd = allStopCommand();
  private final Command teleopCmd = allStopCommand();
  ...
  /**
   * Factory method for a command that cancels all other commands.
   */
  public static Command allStopCommand() {
